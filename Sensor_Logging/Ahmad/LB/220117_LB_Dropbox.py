...
UID126 = "NHT"	#LB_2OG_O_SWK_m_trh1_TairRH
UID127 = "NR8"	#LB_Dach_trh1_TairRH
UID128 = "NH2"	#LB_Dach_trh2_TairRH
...
#___________New Sensor 17.01.2022 ______________________________________#    

    LB_2OG_O_SWK_m_trh1_cdo = BrickletHumidityV2(UID126, ipcon) # Create device object
    
    LB_Dach_trh1_cdo = BrickletHumidityV2(UID127, ipcon) # Create device object
    LB_Dach_trh2_cdo = BrickletHumidityV2(UID128, ipcon) # Create device object
...
# Connect to brickd
 ...
 # Get current date and time
    ...
    ueberschrift = ("Date"+';'\
                            ...
                            +"LB_2OG_O_SWK_m_trh1_Tair (°C)"+';'
                            +"LB_2OG_O_SWK_m_trh1_RH (%)"+';'+';'   
...
#-----------------------17.01.2022--------------------------------------
            try:
                LB_2OG_O_SWK_m_trh1_cdo.set_status_led_config(0)
                LB_2OG_O_SWK_m_trh1_Tair = LB_2OG_O_SWK_m_trh1_cdo.get_temperature()/100.0
                LB_2OG_O_SWK_m_trh1_RH = LB_2OG_O_SWK_m_trh1_cdo.get_humidity()/100.0                              
            except:
                LB_2OG_O_SWK_m_trh1_Tair = str ("#N/V")
                LB_2OG_O_SWK_m_trh1_RH = str ("#N/V")
                print("Sensor-Alarm: LB_2OG_O_SWK_m_trh1 antwortet nicht")  
                
            try:
                LB_Dach_trh1_cdo.set_status_led_config(0)
                LB_Dach_trh1_Tair = LB_Dach_trh1_cdo.get_temperature()/100.0
                LB_Dach_trh1_RH = LB_Dach_trh1_cdo.get_humidity()/100.0                              
            except:
                LB_Dach_trh1_Tair = str ("#N/V")
                LB_Dach_trh1_RH = str ("#N/V")
                print("Sensor-Alarm: LB_Dach_trh1 antwortet nicht")  
                
            try:
                LB_Dach_trh2_cdo.set_status_led_config(0)
                LB_Dach_trh2_Tair = LB_Dach_trh2_cdo.get_temperature()/100.0
                LB_Dach_trh2_RH = LB_Dach_trh2_cdo.get_humidity()/100.0                              
            except:
                LB_Dach_trh2_Tair = str ("#N/V")
                LB_Dach_trh2_RH = str ("#N/V")
                print("Sensor-Alarm: LB_Dach_trh2 antwortet nicht") 
...
#Sensordaten speichern                
            Ausgabe =   (str(day)+','+str(month)+','+str(year)+';'\
                        ...
                        +" "+';'                                
                        +str(LB_2OG_O_SWK_m_trh1_Tair) +';'\
                        +str(LB_2OG_O_SWK_m_trh1_RH) +';'\
                        +" "+';'
                        +str(LB_Dach_trh1_Tair) +';'\
                        +str(LB_Dach_trh1_RH) +';'\
                        +str(LB_Dach_trh2_Tair) +';'\
                        +str(LB_Dach_trh2_RH) +';'\
                        +" "+';'                             
                        +'\n')     
