...
UID15 = "BNWZ" #***(Beton-Nord-Wohnzimmer) [#LB_2OG_N_WZ_pt_Tsk] New Black Globe Thermometer UID changed from (V9F)
#UID16 = "" reserved
...
# Connect to brickd
 ...
 # Get current date and time
    ...
    title_Pyrano = (Jahr+'_'+Monat+'_'+Tag+'_Pyrano'+'.csv')
    filename_Pyrano = os.path.join(save_path_w, title_Pyrano)
    ueberschrift = ("Date"+';'\
                            +"Time"+';'+';'\
